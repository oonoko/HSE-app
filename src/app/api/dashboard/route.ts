...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!admin.is_super_admin && admin.shift_number && shift && Number(shift) !== admin.shift_number) return NextResponse.json({ error: 'Зөвхөн өөрийн ээлжийг харна' }, { status: 403 })
